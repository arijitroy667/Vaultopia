...
export function TransactionHistory() {
  ...
  const getEtherscanLink = (txHash) => {
    ...
    const baseUrl = "https://hoodi.etherscan.io/tx/";
            ...
            <div className="hidden md:flex text-sm">
              <div className="mr-4">
                ...
                <span className="font-medium">
                  ${depositSum.toLocaleString()}
                </span>
              </div>
              <div>
                <span className="text-muted-foreground">Total Withdrawn:</span>{" "}
                <span className="font-medium">
                  ${withdrawSum.toLocaleString()}
                </span>
              </div>
            </div>
            <Button
                  ...
                  {filter === "all" && (
                    <Button
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          const depositTrigger = document.querySelector(
                            '[role="tab"][value="deposit"]'
                          );
                      ...
                      className="gap-2"
                    >
                      <ArrowDown className="h-4 w-4" /> Get Started with a
                      Deposit
                    </Button>
                  )}
